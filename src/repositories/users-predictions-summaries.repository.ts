...
import {Events, Users, UsersPredictionsSummaries, UsersPredictionsSummariesRelations} from '../models';
...
> {
  ...
  public readonly event: BelongsToAccessor<Events, typeof UsersPredictionsSummaries.prototype.id>;

  public readonly user: BelongsToAccessor<Users, typeof UsersPredictionsSummaries.prototype.id>;
